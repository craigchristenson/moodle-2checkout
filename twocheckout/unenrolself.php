...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'twocheckout'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/twocheckout/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_twocheckout', format_string($course->fullname));
